...
| | Within due date, checked by librarian | BR003 | Status remained "Đang mượn" |
...
| TC05-03 | Display "Trả sách" button | - MEM002 is currently active <br> - MEM002 is currently borrowing BOOK003 | Log in account: ba.nguyen@email.com <br> - Go into "Mượn/Trả" | BR001 | Able to click "Trả sách" to return book | REQ 05| Equivalence partitioning |
